...
<html>
	...
	<body>
		...
		<div class="section">
			...
			<ul id="musiclist">
				<li class="mp3item">
					<a href="problem4/musicPHP/songs/paradise-city.mp3">paradise-city.mp3</a>
				</li>
				
				<li class="mp3item">
					<a href="problem4/musicPHP/songs/basket-case.mp3">basket-case.mp3</a>
				</li>

				<li class="mp3item">
					<a href="problem4/musicPHP/songs/all-the-small-things.mp3">all-the-small-things.mp3</a>
				</li>
